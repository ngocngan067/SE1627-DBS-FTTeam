...
<html>
    <head>
        ...
        <link rel="stylesheet" href=".././css/dentist/Feedback.css" />
    </head>
    <body>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-5 cover mb-3">
                                    <p>Service Name:
                                        <input type="text" id="serviceName" readonly value="">
                                    </p>
                                </div>

                                <div class="col-12 col-md-7 cover mb-3">
                                    <p>Dentist Name:
                                        <input type="text" id="dentistName" readonly value="">
                                    </p>
                                </div>
                    ...
                    <div class="row" id="return-list">
                        <c:forEach items="${FEEDBACK_LIST}" var="feedBack">
                            <div class="col-12 my-2 feedback-amount">
                                <div onclick="ViewInformation('${feedBack.fullName}', '${feedBack.gender}', '<fmt:formatDate value="${feedBack.dateOfBirth}" pattern="dd-MM-yyyy"/>', '${feedBack.phoneNumber}', '${feedBack.email}', '${feedBack.address}', '${feedBack.serviceName}', '${feedBack.dentistName}', '${feedBack.feedBackContent}')" class="card-feedback">
                                    <div class="feedback--top">
                                        ...
                                        <button onclick="ViewInformation('${feedBack.fullName}', '${feedBack.gender}', '<fmt:formatDate value="${feedBack.dateOfBirth}" pattern="dd-MM-yyyy"/>', '${feedBack.phoneNumber}', '${feedBack.email}', '${feedBack.address}', '${feedBack.serviceName}', '${feedBack.dentistName}', '${feedBack.feedBackContent}')" class="btn-eye">
                                    ...
                                    <div class="feedback--bottom p-3">
                                        ...
                                        <div class="bottom-content">
                                            ...
                                            <p>
                                                Service: <span class="service">${feedBack.serviceName}</span>
                                            </p>
                                            <p>Doctor: <span>${feedBack.dentistName}</span></p>
        ...
        <script src=".././js/dentist/Feedback.js"></script>
