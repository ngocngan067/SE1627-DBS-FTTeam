...
function CheckUsername() {
    const inputUsername = document.querySelector("#username"),
            usernameIconCheck = document.querySelector("#username-icon-check"),
            usernameIconError = document.querySelector("#username-icon-error"),
            usernameErrorMessage = document.querySelector("#username-error");
...
function CheckPhoneNumber() {
    const inputPhoneNumber = document.querySelector("#phone-number"),
            phoneNumberIconCheck = document.querySelector("#phone-number-icon-check"),
            phoneNumberIconError = document.querySelector("#phone-number-icon-error"),
            phoneNumberErrorMessage = document.querySelector("#phone-number-error");
